    ...
    <div className="space-y-6 pb-20 animate-fade-in">
      ...
      {(showAddModal || showEditModal) && (
        <>
          ...
          <div
            className={`fixed inset-x-0 z-50 ${cardCls} rounded-t-3xl w-full max-w-md mx-auto animate-slide-up`}
              ...
              <div className="px-5 pb-3 flex items-center justify-between shrink-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" onClick={() => { setShowAddModal(false); setShowEditModal(false); }}
                    className="w-8 h-8 flex items-center justify-center rounded-xl bg-stone-100 dark:bg-stone-800 text-stone-500">
                    <X size={16} />
                  </button>
                </div>
              </div>
